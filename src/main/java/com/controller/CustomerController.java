...
public class CustomerController {
    ...
    public ResponseEntity<Customer> updateLastName(@PathVariable Integer customerId, @RequestParam String lastName) {
        Customer updatedCustomer = customerService.updateLastName(customerId, lastName);
